...
Il est très important de lire la documentation 
...
Attention ! arrêter les autres conteneurs Dock 
et être dans le bon projet : cd/bonprojet
puis faire la commande suivante : docker build -t frontend-basic .
...
Fait dans la route http://localhost:8081